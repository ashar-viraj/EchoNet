          ...
          <aside className="w-full lg:w-80 space-y-4">
            <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4 shadow-lg shadow-black/40">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[11px] px-2 py-1 rounded-full bg-slate-800 text-slate-400">Software</span>
              </div>
          ...
          <section className="flex-1 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <h1 className="text-3xl font-semibold text-slate-50">Software</h1>
