...
export default function SoftwarePage() {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(`/api/content/software?${params}`);
          ...
          {showFilters && (
            <aside className="w-full lg:w-80 space-y-6">
              <div className="bg-black/40 backdrop-blur-lg rounded-xl p-6 border border-purple-500/30 shadow-2xl">
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Search</label>
                  <input
                    type="text"
                    value={searchQuery}
                    onChange={(e) => {
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Subject (Tags like MS-DOS, games, etc.)</label>
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Size (VERY Important for Software)</label>
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      type="number"
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Language (Rarely Used)</label>
                  <select
