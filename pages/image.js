          ...
          <aside className="w-full lg:w-80 space-y-4">
            <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-4 shadow-lg shadow-black/40">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[11px] px-2 py-1 rounded-full bg-slate-800 text-slate-400">Images</span>
              </div>
          ...
          <section className="flex-1 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <h1 className="text-3xl font-semibold text-slate-50">Images</h1>
                ...
                {items.map((it, i) => (
                  <div key={`${it.identifier}-${i}`} className="p-5 bg-slate-900/70 border border-slate-800 rounded-2xl hover:border-sky-500/60 transition">
                    ...
                    <div className="mt-4 flex gap-3">
                      ...
                      <button
                        onClick={() => window.location.href = `/view/${encodeURIComponent(it.identifier)}`}
                        className="inline-flex items-center px-4 py-2 rounded-lg border border-slate-700 text-slate-200 hover:border-slate-500 transition text-sm"
                      >
                        View details
                      </button>
                    </div>
