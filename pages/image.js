...
export default function ImagePage() {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(`/api/content/image?${params}`);
          ...
          {showFilters && (
            <aside className="w-full lg:w-80 space-y-6">
              <div className="bg-black/40 backdrop-blur-lg rounded-xl p-6 border border-purple-500/30 shadow-2xl">
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Search Title</label>
                  <input
                    type="text"
                    value={searchQuery}
                    onChange={(e) => {
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Subject (e.g., maps, art, posters)</label>
                ...
                <div className="mb-6">
                  <label className="block text-sm font-semibold mb-2 text-cyan-300">Size (Very Useful for Images)</label>
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      type="number"
