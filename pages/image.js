          ...
          <aside className="w-full lg:w-80 space-y-4">
            <div className="bg-rustic-card border border-rustic rounded-2xl p-4 shadow-lg">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[11px] px-2 py-1 rounded-full bg-white/70 border border-rustic text-rustic-muted">Images</span>
              </div>
          ...
          <section className="flex-1 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <h1 className="text-3xl font-semibold text-rustic-dark text-gradient-rustic">Images</h1>
